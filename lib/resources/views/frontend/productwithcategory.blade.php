					...
					<div class="content-top">
						...
						<div class="col-md-6 col-md">
								<a href="{{asset('category/'.$cate->cate_id.'/'.$cate->cate_slug.'.html')}}" class="b-link-stroke b-animate-go  thickbox">
									<img src="{{asset('lib/storage/app/avatar/'.$cate->cate_img)}}" class="img-responsive" alt=""/><div class="b-wrapper1 long-img"><p class="b-animate b-from-right    b-delay03" style="font-family: bookman;">Sản Phẩm</p><label class="b-animate b-from-right b-delay03"></label><h3 class="b-animate b-from-left b-delay03" style="font-family: bookman;">{{$cate->cate_name}}</h3></div></a>
							</div>
							@endforeach
						<!-- 	<div class="col-md-6 col-md">
								<a href="single.html" class="b-link-stroke b-animate-go  thickbox">
									<img src="images/spddm.jpg" class="img-responsive" alt=""/><div class="b-wrapper1 long-img"><p class="b-animate b-from-right    b-delay03 ">Sản Phẩm</p><label class="b-animate b-from-right    b-delay03 "></label><h3 class="b-animate b-from-left    b-delay03 ">Dưỡng Da Mặt</h3></div></a>
							</div> -->
							<!-- <div class="col-md-6 col-md1">
								<div class="col-3">
									<a href="single.html" class="b-link-stroke b-animate-go  thickbox">
										<img src="images/spbody.png" class="img-responsive" alt=""/>
										<div class="b-wrapper1 long-img">
											<p class="b-animate b-from-right b-delay03 ">Sản Phẩm</p>
											<label class="b-animate b-from-right b-delay03 "></label>
											<h3 class="b-animate b-from-left b-delay03 ">Dưỡng Body</h3>
										</div>
									</a>
								</div>
								<div class="col-3">
									<a href="single.html" class="b-link-stroke b-animate-go  thickbox">
										<img src="images/giamcan.jpg" class="img-responsive" alt=""/>
										<div class="b-wrapper1 long-img">
											<p class="b-animate b-from-right b-delay03 ">Sản Phẩm</p>
											<label class="b-animate b-from-right b-delay03 "></label>
											<h3 class="b-animate b-from-left b-delay03 ">Tăng Giảm Cân</h3>
										</div>
									</a>
								</div>
						...
						<div class="content-mid">
							<h3 style="font-family: bookman;">Sản phẩm {{$cateName->cate_name}}</h3>
